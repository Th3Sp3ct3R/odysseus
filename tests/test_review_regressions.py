...
class _FakeSession:
    # `routes/model_routes.py` imports `Session as DbSession` from
    # core.database; the import stub must export it or the re-import fails
    # with ImportError. Only `endpoint_url` is referenced (a different route).
